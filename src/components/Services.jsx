      ...
      <div class="lg:pr-8 lg:pt-4">
        <div class="lg:max-w-lg">
          ...
          <p class="mt-6 text-lg leading-8 text-gray-600">Lorem, ipsum dolor sit amet consectetur adipisicing elit. 
            Quidem unde animi hic laudantium atque et optio suscipit quasi ad nam.
          ...
          <dl class="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
            <div class="relative pl-9">
              ...
              <dd class="inline">Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe nesciunt error, labore aut voluptate voluptatibus!.
              </dd>
            </div>
            <div class="relative pl-9">
              ...
              <dd class="inline">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam, consequuntur optio iusto a sunt incidunt nostrum! Veniam ducimus enim eligendi.</dd>
            </div>
            <div class="relative pl-9">
              <dt class="inline font-semibold text-gray-900"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                  fill="currentColor" aria-hidden="true" class="absolute left-1 top-1 h-5 w-5 text-indigo-600">
              ...
              <dd class="inline">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis illum natus corrupti quibusdam quasi magni aut perferendis minima labore cumque!
              </dd>
            </div>
          </dl>
        </div>
    ...
    <img src={model} width="2432" height="1442 mx-10" />
      <div class="lg:pr-8 lg:pt-4 mx-5">
        <div class="lg:max-w-lg">
          ...
          <p class="mt-6 text-lg leading-8 text-gray-600">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Explicabo iure asperiores voluptates labore omnis saepe consectetur optio nulla magni expedita!
    ...
    <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
      <div class="lg:pr-8 lg:pt-4">
        <div class="lg:max-w-lg">
          ...
          <p class="mt-6 text-lg leading-8 text-gray-600">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Tempora atque nisi reiciendis maxime tempore. Nam iusto illo praesentium libero! Iure?
          </p>
          <dl class="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
            <div class="relative pl-9">
              <dt class="inline font-semibold text-gray-900"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
